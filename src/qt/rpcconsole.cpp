...
/**
 * Split Gold_Hawgs command line into a list of arguments. Aims to emulate \c bash and friends.
 *
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Gold_Hawgs RPC console.") + "<br>" +
